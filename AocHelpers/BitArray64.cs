...
namespace aoc2020
{
    ...
    public struct BitArray64 : IEquatable<BitArray64>
    {
        ...
        public unsafe ref struct Enumerator
        {
            ...
            public void RequireIndexInBounds()
            {
                if (m_Index >= 0 && m_Index < 64)
                    return;
                throw new IndexOutOfRangeException("Index out of bounds: " + m_Index);
            }
        }
        ...
        public override bool Equals(object? obj) =>
            obj is BitArray64 array64 && Bits == array64.Bits;
        ...
        public override string ToString()
        {
            ...
            for (var num = 1ul << 63; num > 0; num >>= 1, ++i)
            {
